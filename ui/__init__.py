...
def create_history_combo():
    try:
        with open(config.params.PROMPT_HISTORY_FILE, 'r', encoding='utf-8') as file:
...
layout = [
    ...
    [
        sg.P(),
        sg.Button(txt.EXECUTE_TEXT, s=49, font="Default 10 bold", k="-RUN-", button_color=("white", "SeaGreen4"),
                  p=((5, 5), (5, 10))),
        sg.P(),
    ],
